                    ...
                    <form method="post" action="{{ route($route_name . '.store') }}" enctype="multipart/form-data" id="add">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane mt-3 fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="{{ $lang->code }}-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" {{ $lang->code == $main_lang->code ? 'required' : '' }} class="form-control @error('title.'.$lang->code) is-invalid @enderror" name="title[{{ $lang->code }}]" value="{{ old('title.'.$lang->code) }}" id="title" placeholder="Nomi...">
                                ...
                                <div class="form-group">
                                    <label for="menu_id" class="form-label">Amal</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file"  class="form-control" name="file" value="{{ old('file') }}" id="title" placeholder="fayl...">
                                    </div>
                                <div class="form-group">
                                    <!-- Dropzone -->
                                    <label for="dropzone" class="form-label text-capitalize">Sertifikat</label>
