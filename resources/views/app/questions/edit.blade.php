                                        ...
                                        @foreach($langs as $lang)
                                            <div class="tab-pane mt-3 fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="{{ $lang->code }}-tab">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" {{ $lang->code == $main_lang->code ? 'required' : '' }} class="form-control @error('question.'.$lang->code) is-invalid @enderror" name="question[{{ $lang->code }}]"  value="{{ old('question.'.$lang->code) ?? $question->question[$lang->code] ?? null }}" id="question{{ $lang->code }}" placeholder="Savol...">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="answer{{ $lang->code }}" cols="30" rows="10" class="form-control @error('answer.'.$lang->code) is-invalid @enderror ckeditor" name="answer[{{ $lang->code }}]" placeholder="Javob...">{{ old('answer.'.$lang->code) ?? $question->answer[$lang->code] ?? null }}</textarea>
