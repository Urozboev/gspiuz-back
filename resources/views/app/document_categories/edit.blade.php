                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane mt-3 fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="{{ $lang->code }}-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('title.'.$lang->code) is-invalid @enderror" name="title[{{ $lang->code }}]" value="{{ old('title.'.$lang->code) ?? $documentCategory->title[$lang->code] ?? null }}" id="title" placeholder="Nomi...">
