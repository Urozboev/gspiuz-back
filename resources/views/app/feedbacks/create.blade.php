                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane mt-3 fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="{{ $lang->code }}-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" {{ $lang->code == $main_lang->code ? 'required' : '' }} class="form-control @error('name.'.$lang->code) is-invalid @enderror" name="name[{{$lang->code}}]" value="{{ old('name.'.$lang->code) }}" id="name.{{ $lang->code }}" placeholder="F.I.Sh....">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="feedback[{{ $lang->code }}]" id="feedback_{{ $lang->code }}" required cols="30" rows="10" class="form-control @error('feedback.'.$lang->code) is-invalid @enderror ckeditor" name="feedback[{{ $lang->code }}]" placeholder="Fikr..." {{ $lang->code == $main_lang->code ? 'required' : '' }}>{{ old('feedback.'.$lang->code) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('position.'.$lang->code) is-invalid @enderror" name="position[{{ $lang->code }}]" value="{{ old('position.'.$lang->code) }}" id="position" placeholder="Oʻrni...">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('youtube_link') is-invalid @enderror" name="youtube_link" value="{{ old('youtube_link') }}" id="youtube_link" placeholder="havola...">
                                    @error('youtube_link')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('link') is-invalid @enderror" name="link" value="{{ old('link') }}" id="link" placeholder="havola...">
                                    @error('link')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
