                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane mt-3 fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="{{ $lang->code }}-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" {{ $lang->code == $main_lang->code ? 'required' : '' }} class="form-control @error('title.'.$lang->code) is-invalid @enderror" name="title[{{ $lang->code }}]" value="{{ old('title.'.$lang->code) ?? $service->title[$lang->code] ?? null }}" id="title{{ $lang->code }}" placeholder="Sarlavha...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="desc[{{ $lang->code }}]" id="desc{{ $lang->code }}" cols="30" rows="10" class="form-control @error('desc.'.$lang->code) is-invalid @enderror ckeditor" placeholder="Tavsif...">{{ old('desc.'.$lang->code) ?? $service->desc[$lang->code] ?? null }}</textarea>
                                    ...
                                    @endforeach
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" name="slug" value="{{ old('slug') ?? $service->slug ?? null }}" id="slug }}" placeholder="Manzil...">
                                            @error('slug')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
