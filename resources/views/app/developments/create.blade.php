                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane mt-3 fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="{{ $lang->code }}-tab">
                                        <div class="form-group">
                                            <label for="title{{ $lang->code }}" class="form-label {{ $lang->code == $main_lang->code ? 'required' : '' }}">Sarlavha</label>
                                            <input type="text" {{ $lang->code == $main_lang->code ? 'required' : '' }} class="form-control @error('title.'.$lang->code) is-invalid @enderror" name="title[{{ $lang->code }}]" value="{{ old('title.'.$lang->code) }}" id="title{{ $lang->code }}" placeholder="Sarlavha...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('option1.'.$lang->code) is-invalid @enderror" name="option1[{{ $lang->code }}]" value="{{ old('option1.'.$lang->code) }}" id="option1{{ $lang->code }}" placeholder="Variantlar...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('option2.'.$lang->code) is-invalid @enderror" name="option2[{{ $lang->code }}]" value="{{ old('option2.'.$lang->code) }}" id="option2{{ $lang->code }}" placeholder="Variantlar...">
