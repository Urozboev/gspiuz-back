                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') ?? $lang->title }}" id="title" placeholder="Sarlavha...">
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required maxlength="2" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code') ?? $lang->code }}" id="code" placeholder="Kod...">
                                    @error('code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    <!-- Dropzone -->
                                    <label for="dropzone" class="form-label">Ikonka</label>
