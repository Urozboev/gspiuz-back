                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane mt-3 fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="{{ $lang->code }}-tab">
                                            <div class="form-group">
                                                ...
                                                <input type="text" {{ $lang->code == $main_lang->code ? 'required' : '' }} class="form-control @error('title.'.$lang->code) is-invalid @enderror" name="title[{{ $lang->code }}]" value="{{ old('title.'.$lang->code) ?? $post->title[$lang->code] ?? null }}" id="title" placeholder="Sarlavha...">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('subtitle.'.$lang->code) is-invalid @enderror" name="subtitle[{{ $lang->code }}]" value="{{ old('subtitle.'.$lang->code) ?? $post->subtitle[$lang->code] ?? null }}" id="subtitle" placeholder="Qoʻshimcha sarlavha...">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="desc[{{ $lang->code }}]" id="desc" cols="30" rows="10" class="form-control @error('desc.'.$lang->code) is-invalid @enderror ckeditor" name="desc[{{ $lang->code }}]" placeholder="Tavsif...">{{ old('desc.'.$lang->code) ?? $post->desc[$lang->code] ?? null }}</textarea>
                                        ...
                                        @endforeach
                                            <div class="form-group">
                                                <label for="date" class="form-label">Video link for news </label>
                                                <input type="url" id="url" name="url" class="form-control" value="{{ old('url') ??  $post->url ?? null }}" placeholder="vide link..."  />
                                            </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="date" name="file" class="form-control" value="{{ old('file') ?? $post->file }}" placeholder="fayl..."  />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="categories" class="form-label">Turkum</label>
