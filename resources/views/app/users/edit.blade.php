                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') ?? $user->name }}" id="name" placeholder="F.I.Sh....">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') ?? $user->username }}" id="username" placeholder="havola...">
                                    @error('username')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
