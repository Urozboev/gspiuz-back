                            ...
                            <div class="row">
                                <div class="tab-content" id="myTabContent">
                                    <div class="form-group">
                                        ...
                                        <input name="years" class="form-control" placeholder="yillar..." value="{{$employStaff->years}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="menu_id" class="form-label">Erkak</label>
                                        <input name="male" class="form-control" placeholder="erkak..." value="{{$employStaff->male}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="menu_id" class="form-label">Ayol</label>
                                        <input name="female" class="form-control" placeholder="ayol..." value="{{$employStaff->female}}">
                                    </div>
