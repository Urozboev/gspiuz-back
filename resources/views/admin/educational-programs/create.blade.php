...
~
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="second_description[{{ $lang->code }}]" id="desc" cols="30" rows="10" class="form-control @error('second_description.'.$lang->code) is-invalid @enderror ckeditor"  placeholder="Ikkinchi tavsif...">{{ old('second_description.'.$lang->code) }}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="second_description[{{ $lang->code }}]" id="desc" cols="30" rows="10" class="form-control @error('third_description.'.$lang->code) is-invalid @enderror ckeditor" name="third_description[{{ $lang->code }}]" placeholder="Uchinchi tavsif...">{{ old('third_description.'.$lang->code) }}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" {{ $lang->code == $main_lang->code ? 'required' : '' }} class="form-control @error('lang.'.$lang->code) is-invalid @enderror" name="lang[{{ $lang->code }}]" value="{{ old('lang.'.$lang->code) }}" id="title" placeholder="Til...">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" {{ $lang->code == $main_lang->code ? 'required' : '' }} class="form-control @error('map.'.$lang->code) is-invalid @enderror" name="map[{{ $lang->code }}]" value="{{ old('lang.'.$lang->code) }}" id="title" placeholder="Manzil...">
                                                @error('map.'.$lang->code)
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="date" name="file" class="form-control" value="{{ old('file') }}" placeholder="fayl..."  />
                                </div>
                                {{--
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="level" name="level">
                                        ...
                                        <option value="bachelor" @selected(old('level') === 'bachelor')>Bakalavriat</option>
                                        <option value="master" @selected(old('level') === 'master')>Magistratura</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="date" class="form-label">Oʻqish muddati</label>
                                    <input type="text" id="date" name="education_years" class="form-control" value="{{ old('education_years') }}" placeholder="Oʻqish muddati..."  />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " name="order" value="{{ old('order') }}" id="subtitle" placeholder="Tartib...">
                                    @error('order')
                                    <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="date" name="daytime" class="form-control" value="{{ old('daytime') }}" placeholder="Kunduzgi taʼlim narxi..."/>
                                    </div>
                                <div class="form-group">
                                        <label for="part_time" class="form-label">Sirtqi taʼlim narxi</label>
                                        <input type="text" id="part_time" name="part_time" class="form-control" value="{{ old('part_time') }}" placeholder="Sirtqi taʼlim narxi..."  />
                                    </div>
