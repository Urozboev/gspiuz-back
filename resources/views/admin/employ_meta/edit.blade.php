                        ...
                        <form method="post" action="{{ route('employ_meta.update', $employMeta->id) }}" enctype="multipart/form-data" id="add">
                            ...
                            <div class="row">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="form-group">
                                        <label for="employ_type_id" class="form-label">Bandlik turi</label>
                                        <select class="form-select @error('employ_type_id') is-invalid @enderror" id="employ_type_id" data-choices='{"": true}' name="employ_type_id">
                                            @foreach ($employType as $key => $item)
                                                <option value="{{ $item->id }}" {{ old('employ_type_id') ?? $employMeta->employ_type_id == $item->id ? 'selected' : '' }}>{{ $item->name[$main_lang->code] ?? null }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="date" name="slug" class="form-control" value="{{ old('slug') ?? $employMeta->slug }}" />
                                    </div>
                                    <div class="form-group">
                                        <label for="subtitle" class="form-label">Tartib</label>
                                        <input type="number" class="form-control " name="order" value="{{ old('order')?? $employMeta->order ?? null}}" id="subtitle" placeholder="Tartib...">
                                        @error('order')
                                        <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " name="contrakt_number" value="{{ old('contrakt_number') ?? $employMeta->contrakt_number}}" id="subtitle" placeholder="Shartnoma raqami...">
